# Exercice 1 : Ecrire un programme qui fonctionne comme le service Orange Money
#   1. Le programme doit permettre de faire des opérations de base :
#   - Solde de mon compte
#   - Transfer d'argent
#   - Paiement de facture
#   - Achat de credit
#   - Quitter.
from Fonction import afficher_menu, afficher_factures
...
while True:
    ...
    if choix == 1:
        ...
        if montant <= 0:
            ...
            print("Le montant transféré doit être supérieur ou égal à 500 F CFA.")
            continue
        ...
        numero_facture = input(
            "Entrez le numéro de référence de la facture à payer (8 chiffres) : ")
        ...
        print(f"\nVotre facture {choix_facture} N°{numero_facture} de {montant_facture} F CFA a été payée.")
        print(f"Le nouveau solde de votre compte est de : {solde} F CFA\n")
    elif choix == 4:
